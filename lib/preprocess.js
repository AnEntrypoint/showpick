    ...
    getSearchQueries() {
        return [
            ...
            },
            {
                ...
                query: '(("epic fail" OR "gone wrong" OR "fail compilation" OR "funny fails" OR "parkour" OR "extreme sports" OR "stunt fail" OR "try not to laugh" OR "FailArmy" OR "viral fail") AND (funny OR hilarious OR viral OR compilation)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'controversy_documentary',
                query: '(("internet drama" OR "youtuber drama" OR "cancelled" OR "exposed" OR "receipts" OR "drama alert" OR "tea spill" OR "expose") AND (documentary OR breakdown OR analysis OR compilation OR video) AND (2015..2025)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'niche_internet_culture',
                query: '(("meme culture" OR "internet culture" OR "web 1.0" OR "old internet" OR "newgrounds" OR "internet history" OR "archived web" OR "forgotten internet" OR "early youtube" OR "internet nostalgia" OR "flash animation") AND (documentary OR video OR essay OR compilation OR history)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'shock_comedy_specials',
                query: '((edgy OR dark OR cringe OR crude OR sarcastic OR satirical) AND (comedy OR standup OR special OR "comedy special" OR comedian) AND (special OR live OR performance) AND NOT (violence OR gore)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'controversial_creators',
                query: '(("logan paul" OR "jake paul" OR "ricegum" OR "onision" OR "james charles" OR "trisha paytas" OR "tana mongeau" OR "jeffree star") AND (documentary OR breakdown OR expose OR investigation OR essay) AND NOT (harassment OR violence)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'internet_prank_compilation',
                query: '((prank OR "gone wrong" OR "reaction" OR "caught on camera" OR "funny prank") AND (compilation OR montage OR "best of" OR video) AND NOT (harassment OR violence OR assault)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
