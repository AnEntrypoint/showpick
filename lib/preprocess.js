...
class ArchiveVideoFinder {
    ...
    async findAllVideos(callback) {
        const knownCollections = [
            'Norm_Macdonald_Live', 'youtube-RblKvfXfYrY', 'youtube-r0vKqZLrFKE',
            'SNL_2019', 'SNL_2018', 'Key_And_Peele_Comedy', 'ChappelleShow',
            'TheOffice', 'ArrestedDevelopment', 'ItsAlwaysSunny',
            'RickAndMorty', 'SouthPark', 'FamilyGuy', 'BojackHorseman'
        ];
