...
class ArchiveVideoFinder {
    ...
    getSearchQueries() {
        return [
            ...
            },
            {
                ...
                query: '((anime OR "dragon ball" OR dragonball OR "x-men" OR xmen OR spiderman OR "spider-man" OR "final space" OR naruto OR "death note" OR "attack on titan" OR "neon genesis evangelion" OR "serial experiments lain" OR cowboy OR trigun OR hellsing OR akira OR "ghost in the shell" OR "ergo proxy" OR "code geass") NOT (digimon OR spongebob OR "one piece" OR pokemon)) AND (english OR dub OR sub OR "english dub" OR "english sub") AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
            ...
            {
                category: 'shock_value_compilations',
                query: '(("shock value" OR "shock compilation" OR "extreme compilation" OR "insane moments" OR "most shocking" OR "jaw dropping" OR "unbelievable" OR "craziest moments" OR "wildest" OR "gone wrong" OR "danger" OR "risky" OR "stunt gone wrong" OR "epic fail" OR "crazy stunt" OR "adrenaline" OR "extreme sports" OR "cliff diving" OR "parkour") AND (funny OR hilarious OR epic OR insane)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'controversy_documentary',
                query: '(("internet drama" OR "controversy" OR "cancelled" OR "exposed" OR "receipts" OR "call out" OR "discourse" OR "drama alert" OR "tea" OR "expose") AND (documentary OR breakdown OR analysis OR compilation OR "video essay")) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'niche_internet_culture',
                query: '(("4chan" OR "reddit" OR "knowyourmeme" OR "internet" OR "meme culture" OR "subculture" OR "alt internet" OR "deep web" OR "web 1.0" OR "old internet" OR "geocities" OR "newgrounds" OR "ebaumsworld" OR "internet history" OR "archived web" OR "forgotten internet") AND (documentary OR breakdown OR history OR essay OR compilation)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'shock_comedy_specials',
                query: '((shock OR edgy OR offensive OR controversial OR dark OR cringe OR crude) AND (comedy OR standup OR special OR "comedy special" OR comedian) AND (special OR live OR performance)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'controversial_creators',
                query: '(("andrew tate" OR "logan paul" OR "jake paul" OR "ricegum" OR "onision" OR "james charles" OR "trisha paytas" OR "tana mongeau") AND (documentary OR breakdown OR expose OR investigation OR essay)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'internet_prank_compilation',
                query: '((prank OR "gone wrong" OR "gone sexual" OR "reaction" OR "caught on camera" OR "unethical" OR "mean spirited" OR "controversial prank") AND (compilation OR montage OR "best of" OR video)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'cringe_compilations',
                query: '(cringe OR "second hand embarrassment" OR awkward OR uncomfortable OR "bad lip reading" OR "voice dub" OR "dub over" OR weird OR bizarre) AND (compilation OR montage OR "best of") AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'alt_comedy_fringe',
                query: '((alternative OR alt OR underground OR fringe OR experimental) AND (comedy OR standup OR special OR performance OR comedian) AND (edgy OR dark OR satirical OR provocative)) AND mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            }
        ];
    ...
    async processCollection(identifier) {
        try {
            ...
            if (!this.hasRelevantContent(meta)) {
