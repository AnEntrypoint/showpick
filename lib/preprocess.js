...
class ArchiveVideoFinder {
    ...
    getSearchQueries() {
        return [
            {
                category: 'glitch_art',
                query: 'glitch mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'datamosh',
                query: 'datamosh mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'vj_loops',
                query: 'VJ loop mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'abstract_film',
                query: 'abstract film mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'pixel_art',
                query: 'pixel art mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'experimental',
                query: 'experimental animation mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'adult_swim',
                query: 'adult swim mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            },
            {
                category: 'edgy_animation',
                query: 'south park mediatype:(movies OR opensource_movies)',
                filters: [],
                sort: 'downloads desc'
            }
        ];
